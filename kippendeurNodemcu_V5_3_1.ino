 ...
 * 
 * Versions
 * V5.3.1 Bigfixes: MQTTSwitchLuik naming consistency, hourOpen en hourClose setten dmv. MQTT callback
...
//voor NTP
WiFiUDP udp;
EasyNTPClient ntpClient(udp, "pool.ntp.org", ((1*60*60))); // 2 = GMT + 2 zomertijdcorrectie 2*60*60  wintertijd is 1*60*60
...
void setup() {
  ...
  //MQTT
  client.setServer(mqtt_server, 16103); //prod
